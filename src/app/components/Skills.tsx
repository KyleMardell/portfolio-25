        ...
        <section>
            <Container>
                ...
                <Row className="text-center mb-5">
                    <Col xs={6} md={3} className='mb-3' data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="100">
                        <h3 className={styles.SkillsHeading}>Front-End</h3>
                        <p className={styles.SkillsTextTwo}>React, Next.js, JavaScript (ES6+), HTML5, CSS3, Bootstrap</p>
                    </Col>
                    <Col xs={6} md={3} className='mb-3' data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="100">
                        <h3 className={styles.SkillsHeading}>Back-End</h3>
                        <p className={styles.SkillsTextTwo}>Python, Django, Django REST Framework, PostgreSQL</p>
                    </Col>
                    <Col xs={6} md={3} className='mb-3' data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="100">
                        <h3 className={styles.SkillsHeading}>Version Control</h3>
                        <p className={styles.SkillsTextTwo}>Git, GitHub</p>
                    </Col>
                    <Col xs={6} md={3} className='mb-3' data-aos="zoom-out" data-aos-duration="2000" data-aos-delay="100">
                        <h3 className={styles.SkillsHeading}>Other</h3>
                        <p className={styles.SkillsTextTwo}>REST APIs, Deployment (CapRover, VPS), Problem Solving, Organisation</p>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col>
                        ...
                        <p className={styles.SkillsTextOne} data-aos="fade-right" data-aos-duration="2000">
                ...
                <Row className="mt-4">
                    <Col md={6} className="mb-4">
                        <div className="p-3 bg-light rounded shadow-sm h-100">
                            <h3 className={styles.SkillsHeading}>Education</h3>
                            <ul className="list-unstyled mb-0">
                                <li className={styles.SkillsTextTwo} data-aos="fade-right" data-aos-duration="2000">
                                    <strong>Diploma in Full-Stack Software Development</strong><br />
                                    Code Institute (2025)
                                </li>
                                <li className={`${styles.SkillsTextTwo} mt-2`} data-aos="fade-left" data-aos-duration="2000">
